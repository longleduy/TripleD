...
class HeaderForm extends PureComponent {
    ...
    //         if (scrollTop > 64) {
    //             $('#header').addClass(`${styles.headerFix}`);
    //         }
    //         else {
    //             if ($('#header').hasClass(`${styles.headerFix}`)) {
    //                 $('#header').removeClass(`${styles.headerFix}`);
    //             }
    //         }
    //     });
    // }
                    ...
                    <div className={styles.divMenu}>
                        <Link to="/test">
                            <Button className={`${appStyles.buttonSvg} ${styles.menuButton}`}>
                                ...
                                <label className={styles.countNoti}>12</label>          
                            </Button>
                            </Link>
                            <Button className={`${appStyles.buttonSvg}  ${styles.menuButton}`}>
                                <svg viewBox="0 0 24 24">
                                ...
                                <label className={styles.countMess}>78</label> 
                            </Button>
                        <div className={styles.divSearch}>
                            <input type="text" className={styles.searchInput} placeholder="Search keywords..."/>
                        </div>
    ...
    render() {
        const { isAuthen, profileName } = this.props.userInfo.queryUserInfo;
        return <Fragment>
